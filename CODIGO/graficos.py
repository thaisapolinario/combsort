...
def grafico_1_tempo_e_memoria():
    ...
    ax1.set_xlabel('Tamanho da Lista (N)', fontsize=18)

    ax1.set_ylabel('Tempo de Execução (segundos)', color=cor_tempo, fontsize=18)
    ...
    plt.title('Desempenho de Tempo e Memória do Comb Sort (Caso Médio)', fontsize=20)
    fig.tight_layout()
...
def grafico_2_cenarios_combsort():
    ...
    print(df.columns)
    plt.title('Tempo de Execução do Comb Sort por Cenário de Entrada', fontsize=20)
    plt.xlabel('Tamanho da Lista (N)', fontsize=14)
    ...
    plt.legend(title='Cenário', fontsize=15, title_fontsize=15) 
...
def grafico_3_comparativo_algoritmos():
    ...
    for cenario in cenarios:
        ...
        plt.title(f'Comparativo de Desempenho: {cenario}', fontsize=20)
        plt.xlabel('Tamanho da Lista (N)', fontsize=14)
        plt.ylabel('Tempo de Execução (segundos)', fontsize=14)
        plt.grid(True, which="both", ls="--")
        plt.legend(title='Algoritmo', fontsize=14, title_fontsize=15)
